...
const Administrator = React.lazy(() => import('./views/Pages/Administrator'));
const Events = React.lazy(() => import('./views/Pages/Events'));
const Rewards = React.lazy(() => import('./views/Pages/Rewards'));
...
const routes = [
  ...
  { path: '/administrator', exact: true, name: 'Administrator', component: Administrator },
